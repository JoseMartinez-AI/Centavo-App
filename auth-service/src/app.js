...
export function createApp(customAuthRouter = null) {
  const app = express();
  ...
  app.use((req, res, next) => {
    // Sanitizamos la query y evitamos imprimir req.body o req.headers directos para no fugar credenciales
  ...
  app.use('/api/auth', customAuthRouter || authRouter);
